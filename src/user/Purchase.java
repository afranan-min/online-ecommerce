...
public class Purchase extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(model.getRowCount()>0){
            ...
            for(int i=0;i<model.getRowCount();i++){
                ...
                purchase.insert(id, uid, uname, uphone, pid, pname, q, pri, tot, purchasedate, adress, null, null, "Pending");
                int newquantity=purchase.getQty(pid)-q;
                purchase.updatetQty(pid,newquantity);
                //setDefault();
            }
            statistics.user(uid);
    ...
    public void setDefault(){
        setVisible(false);
        UserDashboard.jPanel13.setBackground(pc);
        UserDashboard.jPanel14.setBackground(pc);
        UserDashboard.jLabel17.setForeground(tpc);
        UserDashboard.jLabel44.setVisible(true);
        UserDashboard.jLabel28.setVisible(false);
    }
    /**
